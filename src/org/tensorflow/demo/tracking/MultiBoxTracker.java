...
public class MultiBoxTracker {
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final Pair<Float, RectF> detection : screenRects) {
      ...
      borderedText.drawText(canvas, rect.centerX(), rect.centerY(), "" + detection.first,Color.RED);
    }
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      if (getFrameToCanvasMatrix().mapRect(trackedPos)) {
        ...
        borderedText.drawText(canvas, trackedPos.right, trackedPos.bottom, labelString,recognition.color);
      }
    }
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      else if(recognition.title.equals("IO")){
